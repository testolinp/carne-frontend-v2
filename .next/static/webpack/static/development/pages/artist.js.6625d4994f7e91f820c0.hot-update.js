...
/* harmony import */ var react_palette__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! react-palette */ "./node_modules/react-palette/dist/react-palette.umd.js");
/* harmony import */ var react_palette__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(react_palette__WEBPACK_IMPORTED_MODULE_6__);
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Work, [{
    ...
    value: function render() {
      ...
      return model.image.map(function (work, index) {
        ...
        var _usePalette = Object(react_palette__WEBPACK_IMPORTED_MODULE_6__["usePalette"])(work.url),
            data = _usePalette.data,
            loading = _usePalette.loading,
            error = _usePalette.error;

        var imageBackground = {
          backgroundImage: imageDisplay != 'v' ? 'url(' + work.url + ')' : 'none',
          backgroundColor: imageDisplay != 'v' ? '#000' : data.vibrant
...
//# sourceMappingURL=artist.js.6625d4994f7e91f820c0.hot-update.js.map